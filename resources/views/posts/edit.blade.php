...
<form action="{{ route('post.update') }}" enctype="multipart/form-data" method="post">
    ...
    <div class="container">
        ...
        <input type="text" id="nickname" class="form-control" name="nickname" value="{{ $post->nickname }}">
        <br>
        @error('sauna_name')
        ...
        <input type="text" id="sauna_name" class="form-control" name="sauna_name" value="{{ $post->sauna_name}}">
        <br>
        <br>
